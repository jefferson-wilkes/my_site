  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-6 py-14 space-y-14">
        ...
        {/* Links */}
        <section>
          <h2 className="text-lg font-semibold text-slate-800 mb-4">Links</h2>
      ...
      <footer className="border-t border-slate-100 text-center text-sm text-slate-400 py-6">
        &copy; {new Date().getFullYear()} Jefferson Wilkes
      </footer>
